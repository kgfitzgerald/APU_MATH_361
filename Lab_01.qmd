...
1.  Add "MATH 361" as a subtitle. Hint `subtitle:` goes right below `title:`.
...
> *Note: we use the language "print \_\_\_" to mean "tell R to show the values stored in the object named \_\_\_\_." You don't need to physically print the results :)*
...
Once you have completed Tasks 1 - 6, render the document one last time. Look over the .html document to make sure that everything is visible and formatted as you intended. To submit this lab assignment, you need to export your .html document from RStudio Cloud and then upload it to the Lab 00 assignment on Canvas.

To export the file,

-   Navigate to the Files pane in RStudio Cloud (bottom right quadrant, to the left of the Viewer tab)
...
-   In the pop-up window, navigate to your Downloads folder and select your html file
