...
The following code combines the vectors into a data frame, and creates summary tables and a visualization for the distribution of `X`. Remove `eval: false` so the output will in your html.
